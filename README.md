...
> **Security Note:** To prevent unauthorized access and potential abuse, our live Supabase API keys and URLs are kept private and are **not** committed to this public repository.
